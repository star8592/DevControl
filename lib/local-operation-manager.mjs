...
export function buildLocalOperationInvocation({ action, project = null, force = false, projectRegistry }) {
...
export function createLocalOperationManager({ baseDir, projectRegistry, onFinish = null }) {
  ...
  function start({ action, project = null, force = false }) {
    const invocation = buildLocalOperationInvocation({ action, project, force, projectRegistry });
    if (activeId) {
