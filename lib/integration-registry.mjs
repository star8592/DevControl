...
function normalizeIntegration(key, value) {
  ...
  if (value.model !== undefined) assert(typeof value.model === 'string' && value.model.length <= 200, `${key}.model is invalid`);
  if (value.protocol !== undefined) assert(['responses', 'chat-completions'].includes(value.protocol), `${key}.protocol is invalid`);
